# Generated by Django 4.2.5 on 2024-02-23 08:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panchayath_name', models.CharField(blank=True, default='', max_length=100, null=True)),
                ('ward_number', models.CharField(blank=True, default='', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applied_by', models.CharField(max_length=150)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('complaint_type', models.CharField(choices=[('work_related', 'Work Related'), ('job_card_related', 'Job Card Related'), ('workers_job_related', "Worker's Job Related")], max_length=20)),
